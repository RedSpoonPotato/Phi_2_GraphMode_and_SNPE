...
std::string modelLaunch(
    ...
    if (firstRun) {
        ...
        allocate_model_input_buffers(*models, first_model_buffer_sizes, debug, datasize, isTFBuffer);
        // return x;
        ...
        allocate_model_output_buffers(*models, first_model_output_buffer_sizes, debug, datasize, isTFBuffer);
