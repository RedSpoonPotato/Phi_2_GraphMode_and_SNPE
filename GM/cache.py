# credit to https://github.com/huggingface/transformers/blob/main/src/transformers/cache_utils.py
...
class DynamicCache(Cache):
    ...
    def reorder_cache(self, beam_idx: tf.Tensor):
        ...
        for layer_idx in range(len(self.key_cache)):
            ...
            self.value_cache[layer_idx] = tf_index_select(self.value_cache[layer_idx], 0, beam_idx)
